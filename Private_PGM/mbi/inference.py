...
# LICENSE file in the {root}/Private_PGM/ directory of this source tree.
import numpy as np
...
class FactoredInference:
    def __init__(
        ...
        :param domain: The domain informsation (A Domain object)
    ...
    def _setup(self, measurements, total):
        ...
        if not self.warm_start or not hasattr(self, "model"):
            ...
            zeros = {
                cl: self.Factor.zeros(self.domain.project(cl))
