                ...
                for attr in layer.attrs_marginal:
                    try:
                        self.graph.remove_edge(
                            layer.attrs_marginal[attr][0], layer.attrs_marginal[attr][1]
                        )
    ...
    def append_attrs(self, df, views):
        for index, layer in enumerate(self.clip_layers[::-1]):
            ...
            for append_attr in layer.attrs:
                ...
                marginal = views[
                    layer.attrs_marginal[append_attr]
                ...
                for value in unique_value:
                    ...
                    if (
                        self.domain.attr_index_mapping[anchor_attr]
                        < self.domain.attr_index_mapping[append_attr]
                    ):
