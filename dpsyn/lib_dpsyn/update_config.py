...
from dpsyn.lib_dpsyn.records_update import RecordUpdate
...
class UpdateConfig:
    ...
    def update_order(self, iteration, views, iterate_keys):
        ...
        sort_error_tracker = self.update.error_tracker.sort_values(
            by="%s-before" % (iteration,), ascending=False
        )
    ...
    def update_records(self, original_view, view_key, iteration):
        ...
        self.update.update_records_before(view, view_key, iteration)
